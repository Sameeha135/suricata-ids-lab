...
| Aug 11–12 | `2026-08-11_to_2026-08-12_PCAP-Nikto` | Nikto web-scan replay (Aug 11); ET scraping wrapped up here too (Aug 12)
...
## Rule dataset
Complete info about all files related to this is present in an MD file at this path: suricata-ids-lab\2026-07-20_to_2026-07-22_Rules-JSON-Scraping\JSON File for Rules\JSON Making
...
- Google Drive (datasets, PCAPs, exports): https://drive.google.com/drive/folders/1T34UG8KOcZlSBnYT4ovgHsslwKf3OgWv?usp=sharing